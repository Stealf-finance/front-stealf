...
function sha256(data) {
  ...
  result.writeUInt32BE(h0, 0); result.writeUInt32BE(h1, 4); result.writeUInt32BE(h2, 8); result.writeUInt32BE(h3, 12);
  result.writeUInt32BE(h4, 16); result.writeUInt32BE(h5, 20); result.writeUInt32BE(h6, 24); result.writeUInt32BE(h7, 28);
  return result;
}
  ...
  if (algorithm === 'sha256') {
    ...
    return {
      update(input) {
        ...
        data = Buffer.concat([data, inputBuffer]);
        return this;
      },
      digest(encoding) {
