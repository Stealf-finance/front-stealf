...
export const authStorage = {
  ...
  async setUserData(userData: any): Promise<void> {
    try {
      ...
      if (__DEV__) console.error('Failed to save user data to SecureStore:', error);
    }
  },
  /**
  ...
  async getUserData(): Promise<any | null> {
    try {
      ...
      if (__DEV__) console.error('Failed to get user data from SecureStore:', error);
      return null;
    }
  },
  /**
  ...
  async clearUserData(): Promise<void> {
    try {
      ...
      if (__DEV__) console.error('Failed to clear user data from SecureStore:', error);
    }
  }
}