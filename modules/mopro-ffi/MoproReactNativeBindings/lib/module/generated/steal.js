...
/* eslint-disable */
// @ts-nocheck
import nativeModule from "./steal-ffi.js";
...
export function moproHelloWorld() {
  return FfiConverterString.lift(uniffiCaller.rustCall(/*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_steal_fn_func_mopro_hello_world(callStatus);
...
export function generateCircomProof(zkeyPath, circuitInputs, proofLib) /*throws*/{
  return FfiConverterTypeCircomProofResult.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_steal_fn_func_generate_circom_proof(FfiConverterString.lower(zkeyPath), FfiConverterString.lower(circuitInputs), FfiConverterTypeProofLib.lower(proofLib), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function verifyCircomProof(zkeyPath, proofResult, proofLib) /*throws*/{
  return FfiConverterBool.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_steal_fn_func_verify_circom_proof(FfiConverterString.lower(zkeyPath), FfiConverterTypeCircomProofResult.lower(proofResult), FfiConverterTypeProofLib.lower(proofLib), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function generateHalo2Proof(srsPath, pkPath, circuitInputs) /*throws*/{
  return FfiConverterTypeHalo2ProofResult.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_steal_fn_func_generate_halo2_proof(FfiConverterString.lower(srsPath), FfiConverterString.lower(pkPath), FfiConverterMapStringArrayString.lower(circuitInputs), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function verifyHalo2Proof(srsPath, vkPath, proof, publicInput) /*throws*/{
  return FfiConverterBool.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_steal_fn_func_verify_halo2_proof(FfiConverterString.lower(srsPath), FfiConverterString.lower(vkPath), FfiConverterArrayBuffer.lower(proof), FfiConverterArrayBuffer.lower(publicInput), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function generateNoirProof(circuitPath, srsPath, inputs, onChain, vk, lowMemoryMode) /*throws*/{
  return FfiConverterArrayBuffer.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_steal_fn_func_generate_noir_proof(FfiConverterString.lower(circuitPath), FfiConverterOptionalString.lower(srsPath), FfiConverterArrayString.lower(inputs), FfiConverterBool.lower(onChain), FfiConverterArrayBuffer.lower(vk), FfiConverterBool.lower(lowMemoryMode), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function getNoirVerificationKey(circuitPath, srsPath, onChain, lowMemoryMode) /*throws*/{
  return FfiConverterArrayBuffer.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_steal_fn_func_get_noir_verification_key(FfiConverterString.lower(circuitPath), FfiConverterOptionalString.lower(srsPath), FfiConverterBool.lower(onChain), FfiConverterBool.lower(lowMemoryMode), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function verifyNoirProof(circuitPath, proof, onChain, vk, lowMemoryMode) /*throws*/{
  return FfiConverterBool.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_steal_fn_func_verify_noir_proof(FfiConverterString.lower(circuitPath), FfiConverterArrayBuffer.lower(proof), FfiConverterBool.lower(onChain), FfiConverterArrayBuffer.lower(vk), FfiConverterBool.lower(lowMemoryMode), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
/**
...
function uniffiEnsureInitialized() {
  ...
  const scaffoldingContractVersion = nativeModule().ubrn_ffi_steal_uniffi_contract_version();
  if (bindingsContractVersion !== scaffoldingContractVersion) {
    throw new UniffiInternalError.ContractVersionMismatch(scaffoldingContractVersion, bindingsContractVersion);
  }
  if (nativeModule().ubrn_uniffi_steal_checksum_func_mopro_hello_world() !== 47288) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_steal_checksum_func_mopro_hello_world");
  }
  if (nativeModule().ubrn_uniffi_steal_checksum_func_generate_circom_proof() !== 49274) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_steal_checksum_func_generate_circom_proof");
  }
  if (nativeModule().ubrn_uniffi_steal_checksum_func_verify_circom_proof() !== 915) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_steal_checksum_func_verify_circom_proof");
  }
  if (nativeModule().ubrn_uniffi_steal_checksum_func_generate_halo2_proof() !== 60099) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_steal_checksum_func_generate_halo2_proof");
  }
  if (nativeModule().ubrn_uniffi_steal_checksum_func_verify_halo2_proof() !== 62303) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_steal_checksum_func_verify_halo2_proof");
  }
  if (nativeModule().ubrn_uniffi_steal_checksum_func_generate_noir_proof() !== 64019) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_steal_checksum_func_generate_noir_proof");
  }
  if (nativeModule().ubrn_uniffi_steal_checksum_func_get_noir_verification_key() !== 44942) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_steal_checksum_func_get_noir_verification_key");
  }
  if (nativeModule().ubrn_uniffi_steal_checksum_func_verify_noir_proof() !== 25433) {
    throw new UniffiInternalError.ApiChecksumMismatch("uniffi_steal_checksum_func_verify_noir_proof");
  }
}
